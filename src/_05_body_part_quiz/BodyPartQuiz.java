...
public class BodyPartQuiz {
	...
	private void startQuiz() {
		...
		// -- Tell them they are wrong and who the person is
			...
			JOptionPane.showMessageDialog(null, "You are incorrect, it is Arnold");
		}
		...
		if (guess2.contentEquals("Leonardo")) {
			...
			JOptionPane.showMessageDialog(null, "You are incorrect, it is Leonardo");
		}
		showNextImage();
		...
		if (guess3.contentEquals("Morgan")) {
			...
			JOptionPane.showMessageDialog(null, "You are incorrect, it is Morgan");
		}
		showNextImage();
		...
		if (guess4.contentEquals("Jack")) {
			...
			JOptionPane.showMessageDialog(null, "You are incorrect, it is Jack");
		}
